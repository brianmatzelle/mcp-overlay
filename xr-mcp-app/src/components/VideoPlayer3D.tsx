/**
 * VideoPlayer3D — HLS video player rendered as a Three.js plane.
 * Ported from garvis/xr-client/src/features/video/VideoContent.tsx.
 * Uses hls.js for stream loading and VideoTexture for 3D rendering.
 */

import { useRef, useState, useEffect, useCallback } from 'react'
import { Text } from '@react-three/drei'
import * as THREE from 'three'
import { colors, typography, opacity, zLayers } from '../design-system.ts'
...
export function VideoPlayer3D({ url, width = 0.45 }: VideoPlayer3DProps) {
